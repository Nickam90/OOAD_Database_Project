...
/**
 * Servlet implementation class TournamentSelectorServlet
 */
@WebServlet("/TournamentSelectorServlet")
public class TournamentSelectorServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TournamentSelectorServlet() {
        super();
